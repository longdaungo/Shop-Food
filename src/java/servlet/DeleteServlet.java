...
public class DeleteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            updateDate = pattern.format(date);
            ...
            String idrowsUpdateproduct = String.valueOf(++rowsupdateproduct);
            daoupdateproduct.insertUpdatedProduct(idrowsUpdateproduct, id, userid, updateDate, "Delete");
