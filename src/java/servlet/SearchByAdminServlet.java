 ...
 * @author IT
 */
@WebServlet(name = "SearchByAdminServlet", urlPatterns = {"/SearchByAdminServlet"})
public class SearchByAdminServlet extends HttpServlet {
     ...
     */
    private static final Logger LOGGER = Logger.getLogger(SearchByAdminServlet.class);
    private final String SEARCH = "searchadmin.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(stringmoneyFrom == null & stringmoneyTo == null){
                listAllProducts = dao.getProductsByAdmin(pageIndex,searchValue,category);
                count = dao.countProductsByAdmin(searchValue,category);
            }
                ...
                listAllProducts = dao.getProductsByPriceAndNameByAdmin(pageIndex, searchValue, moneyFrom, moneyTo,category);
                count = dao.countProductsByPriceByAdmin(searchValue, category, moneyFrom, moneyTo);
            }
